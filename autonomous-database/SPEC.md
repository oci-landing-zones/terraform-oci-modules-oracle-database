...
| Name | Description |
| ---- | ----------- |
| <a name="output_autonomous_database_resources"></a> [autonomous\_database\_resources](#output\_autonomous\_database\_resources) | Alias for autonomous\_databases\_resources for integrations that read the singular Autonomous Database output name. |
